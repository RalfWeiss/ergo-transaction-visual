...
export const TruncatedLabeledValueEntry = ({label, value}:LabeledValueEntryProps) => (
  <LabeledValueEntry label={label} value={truncateWithEllipses(TRUNCATE_MAXLEN)(value)} />
  // <tr key={label}>
  //   <td style={{textAlign:'right'}}>{label}:</td>
