...
const withAsssetDefaults = (obj: any): Asset =>
  R.pipe(R.pick(assetKeys), R.mergeRight(assetDefaults))(obj);
...
export const transform = (asset: Asset): Asset => {
  ...
  return R.pipe(withAsssetDefaults, R.evolve(transformations))(asset);
};
