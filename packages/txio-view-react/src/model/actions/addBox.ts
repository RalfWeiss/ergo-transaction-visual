...
const addBoxByIdAndType = (boxType: string) => (id: string) => (box: ErgoBox) =>
  R.evolve({
...
export const addInputBox = (box: ErgoBox) => addBoxByType("inputBox")(box);

export const addOutputBox = (box: ErgoBox) => addBoxByType("outputBox")(box);
